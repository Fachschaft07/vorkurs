...
public class Aufg1a
{
	...
	\part Weisen Sie einer byte-Variable den Wert einer int-Variable zu. Warum führt führt die Zuweisung zu Informationsverlust?
...
$$\textsf{Fahrenheit} = \frac{9}{5} * \textsf{Celsius}$$
