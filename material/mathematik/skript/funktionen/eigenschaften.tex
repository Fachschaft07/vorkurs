...
\begin{figure}[h!]
 ...
 \end{tikzpicture}
 \caption{Eine Funktion mit einer endlichen $\mathbb{D} = \{a, b, c, d\}$ Definitionsmenge (rechts) und einer endlichen Zielmenge $Z = \{1, 2, 3, 4, 5\}$ und einer Bildmenge $\mathbb{W} = \{1,2,4\}$. Alle Elemente aus $\mathbb{D}$ besitzen genau eine \glqq Verbindung\grqq .}
\end{figure}
