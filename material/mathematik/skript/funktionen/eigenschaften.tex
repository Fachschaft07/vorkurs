...
Eine Funktion $f$ ist surjektiv genau dann wenn jeder Wert der Zielmenge (mindestens einmal) angenommen wird:
\begin{equation*}
...
Eine Funktion $f$ ist injektiv genau dann wenn jeder Wert der Bildmenge nicht mehrmals angenommen wird:
\begin{equation*}
