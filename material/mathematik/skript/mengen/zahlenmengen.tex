...
\paragraph{Beispiel (informell):} \textit{Das Intervall I umfasst alle nat"urlichen Zahlen gr"o"ser 1 und kleiner 6.}
% Diese Grenzen k"onnen auch plus/minus unendlich also $+ \infty$ oder $- \infty$  annehmen. Lieber rausnehmen - wenn das Intervall unendlich _enth"alt_, dann ist die Supermenge R vereinigt mit Unendlich... Gemeint ist wohl eher, dass die obere/untere Schranke (-)unendlich sein kann, nicht, dass das Intervall unendlich enth"alt.
